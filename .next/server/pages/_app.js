...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NEXT_PUBLIC_SUPABASE_URL": () => (/* binding */ NEXT_PUBLIC_SUPABASE_URL),
/* harmony export */   "NEXT_PUBLIC_SUPABASE_ANON_KEY": () => (/* binding */ NEXT_PUBLIC_SUPABASE_ANON_KEY),
/* harmony export */   "DEFAULT_AVATARS_BUCKET": () => (/* binding */ DEFAULT_AVATARS_BUCKET)
/* harmony export */ });
const NEXT_PUBLIC_SUPABASE_URL = "https://cldwsdgjkazsffrdzpos.supabase.co";
const NEXT_PUBLIC_SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYyOTUwOTAyNCwiZXhwIjoxOTQ1MDg1MDI0fQ.zA_fgQAXnHqCLMBH0VsDI8slrpYRPKRvKbJR2e0XWF0";
...
/* harmony import */ var zustand__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! zustand */ "zustand");
/* harmony import */ var zustand__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(zustand__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _supabaseClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./supabaseClient */ "./lib/supabaseClient.ts");
...
const {
  Provider,
  useStore
} = zustand_context__WEBPACK_IMPORTED_MODULE_2___default()();
const createStore = () => zustand__WEBPACK_IMPORTED_MODULE_0___default()((set, get) => ({
  authView: 'sign_in',
  error: '',
  email: '',
  password: '',
  ...
  handleSignIn: async event => {
    ...
    const {
      error: signInError
    } = await _supabaseClient__WEBPACK_IMPORTED_MODULE_1__.supabase.auth.signIn({
      email,
      password
    });
    if (signInError) set({
  ...
  handleSignUp: async event => {
    ...
    const {
      error: signUpError
    } = await _supabaseClient__WEBPACK_IMPORTED_MODULE_1__.supabase.auth.signUp({
      email,
      password
    });
    if (signUpError) set({
  ...
  handlePasswordReset: async event => {
    ...
    const {
      error
    } = await _supabaseClient__WEBPACK_IMPORTED_MODULE_1__.supabase.auth.api.resetPasswordForEmail(email);
    if (error) set({
      error: error.message
    });else set({
...
if (!_constants__WEBPACK_IMPORTED_MODULE_1__.NEXT_PUBLIC_SUPABASE_URL) throw new Error('Missing env.NEXT_PUBLIC_SUPABASE_URL');
if (!_constants__WEBPACK_IMPORTED_MODULE_1__.NEXT_PUBLIC_SUPABASE_ANON_KEY) throw new Error('Missing env.NEXT_PUBLIC_SUPABASE_ANON_KEY');
const supabase = (0,_supabase_supabase_js__WEBPACK_IMPORTED_MODULE_0__.createClient)(_constants__WEBPACK_IMPORTED_MODULE_1__.NEXT_PUBLIC_SUPABASE_URL, _constants__WEBPACK_IMPORTED_MODULE_1__.NEXT_PUBLIC_SUPABASE_ANON_KEY);
...
/* harmony import */ var _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/supabaseClient */ "./lib/supabaseClient.ts");
/* harmony import */ var _lib_store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../lib/store */ "./lib/store.ts");
/* harmony import */ var _lib_sessionStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../lib/sessionStore */ "./lib/sessionStore.ts");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! next/router */ "next/router");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_8__);


var _jsxFileName = "/home/lukatoni/DockerProjects/NextProjects/invoice-creator/pages/_app.tsx";
...
function MyApp({
  ...
  const Usession = (0,_lib_sessionStore__WEBPACK_IMPORTED_MODULE_7__.useStore)(state => state.Usession);
  const setSession = (0,_lib_sessionStore__WEBPACK_IMPORTED_MODULE_7__.useStore)(state => state.setSession);
  react__WEBPACK_IMPORTED_MODULE_2___default().useEffect(() => {
    const userSession = _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_5__.supabase.auth.session();
    ...
    _lib_supabaseClient__WEBPACK_IMPORTED_MODULE_5__.supabase.auth.onAuthStateChange((_event, session) => {
      if (!session) {
        next_router__WEBPACK_IMPORTED_MODULE_8___default().push('/');
      } else {
  ...
  return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_lib_store__WEBPACK_IMPORTED_MODULE_6__.Provider, {
    createStore: _lib_store__WEBPACK_IMPORTED_MODULE_6__.createStore,
    children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)((react__WEBPACK_IMPORTED_MODULE_2___default().Fragment), {
      children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)((next_head__WEBPACK_IMPORTED_MODULE_1___default()), {
        ...
        lineNumber: 65,
        columnNumber: 2
      }, this), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_material_ui_styles__WEBPACK_IMPORTED_MODULE_3__.ThemeProvider, {
        theme: _lib_theme__WEBPACK_IMPORTED_MODULE_4__.default,
        children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_material_ui_core_CssBaseline__WEBPACK_IMPORTED_MODULE_10__.default, {}, void 0, false, {
          fileName: _jsxFileName,
          lineNumber: 70,
          columnNumber: 9
